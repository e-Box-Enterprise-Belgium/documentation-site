...
If there is a problem with the online form, you can [download the offline form as a docx file](https://www.eboxenterprise.be/fr/documents/word/e-Box_Entreprise_FicheDemandeEnvoi_FR.docx) and send it completed to [eBoxIntegration@smals.be](mailto:eBoxIntegration@smals.be).
